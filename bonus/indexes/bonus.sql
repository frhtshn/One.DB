...
-- bonus_types
CREATE INDEX IF NOT EXISTS idx_bonus_types_client ON bonus.bonus_types USING btree(client_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_bonus_types_code ON bonus.bonus_types USING btree(client_id, type_code);

-- bonus_rules — temel indexler
CREATE INDEX IF NOT EXISTS idx_bonus_rules_client ON bonus.bonus_rules USING btree(client_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_bonus_rules_code ON bonus.bonus_rules USING btree(client_id, rule_code);
...
-- promo_codes
CREATE INDEX IF NOT EXISTS idx_promo_codes_client ON promotion.promo_codes USING btree(client_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_promo_codes_code ON promotion.promo_codes USING btree(client_id, code);
-- Promo code lookup (case-insensitive)
CREATE INDEX IF NOT EXISTS idx_promo_codes_lookup ON promotion.promo_codes USING btree(client_id, upper(code)) WHERE is_active = true;
...
-- campaigns
CREATE INDEX IF NOT EXISTS idx_campaigns_client ON campaign.campaigns USING btree(client_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_campaigns_code ON campaign.campaigns USING btree(client_id, campaign_code);
