...
COMMENT ON TABLE backoffice.auth_audit_log IS 'Stores security-related events such as login, logout, and password changes. Used by AuthAuditDataService and AuthAuditConsumer.';
