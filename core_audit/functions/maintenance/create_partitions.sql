...
-- core_audit veritabanı için daily partition yönetimi
-- Bugün + 7 gün ileri partition oluşturur
...
BEGIN
    ...
    FOR v_tbl IN
        SELECT * FROM (VALUES
            ('backoffice', 'auth_audit_log', 'created_at')
...
COMMENT ON FUNCTION maintenance.create_partitions(INT) IS 'Creates daily partitions for core_audit tables. Look-ahead: today + N days. Idempotent.';
