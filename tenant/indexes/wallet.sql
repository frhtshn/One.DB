...
CREATE INDEX idx_wallets_currency_type ON wallet.wallets USING btree(currency_type);
...
CREATE INDEX idx_wallet_snapshots_updated ON wallet.wallet_snapshots USING btree(updated_at DESC);
