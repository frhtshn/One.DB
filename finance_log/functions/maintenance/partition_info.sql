...
-- finance_log veritabanı için monitoring ve health check
...
COMMENT ON FUNCTION maintenance.partition_info() IS 'Reports partition status for all partitioned tables in finance_log. Shows count, size, oldest/newest partitions.';
