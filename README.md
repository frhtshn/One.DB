...
// create db
"C:\Program Files\PostgreSQL\17\bin\psql.exe" -h 207.180.241.230 -p 5433 -U postgres -d postgres -f create_dbs.sql

// Deploy core
"C:\Program Files\PostgreSQL\17\bin\psql.exe" -h 207.180.241.230 -p 5433 -U postgres -d core -f deploy_core.sql

// Deploy tenant 
"C:\Program Files\PostgreSQL\17\bin\psql.exe" -h 207.180.241.230 -p 5433 -U postgres -d tenant -f deploy_tenant.sql
