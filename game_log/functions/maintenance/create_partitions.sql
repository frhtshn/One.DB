...
-- game_log veritabanı için daily partition yönetimi
...
COMMENT ON FUNCTION maintenance.create_partitions(INT) IS 'Creates daily partitions for game_log tables. Look-ahead: today + N days. Idempotent.';
