...
COMMENT ON FUNCTION maintenance.run_maintenance(INT, INT) IS 'Main maintenance function for cron jobs. Creates future partitions and drops expired ones. Default retention: 7 days.';
