...
-- tenant_report veritabani icin monitoring ve health check
...
COMMENT ON FUNCTION maintenance.partition_info() IS 'Reports partition status for all partitioned tables in tenant_report. Shows count, size, oldest/newest partitions.';
