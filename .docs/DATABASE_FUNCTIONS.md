...
- **`tenant_create`**: Creates a new tenant and assigns supported currencies/languages.
...
- **`tenant_update`**: Updates tenant details and syncs supported currencies/languages.
