...
> **Cross-DB ilişki:** Core DB'den yetki kontrolü + katalog referansları (theme_id, jurisdiction_id, navigation template) backend tarafından yapılır. Tenant DB fonksiyonları Core DB'ye doğrudan erişmez.
...
| p_slug | VARCHAR(255) | Evet | — | SEO-friendly URL (tenant UNIQUE) |
...
**İş Kuralları:** Her zaman `is_locked = FALSE`, `is_readonly = FALSE`, `template_item_id = NULL` (tenant-owned). `p_parent_id` verilmişse varlık kontrolü.
...
1. **Yetki kontrolü backend'de yapılır:** Tenant DB fonksiyonları yetki kontrolü yapmaz — Core DB `user_assert_*` fonksiyonları kullanılır.
2. **Cross-DB referanslar:** `theme_id`, `jurisdiction_id`, `game_id`, `template_item_id` backend'de Core DB'den doğrulanır. Tenant DB'de FK yoktur.
...
5. **Slug benzersizliği:** `contents.slug` tenant içinde UNIQUE INDEX.
...
| Her ikisi `FALSE` | Serbest öğe (tenant-owned) | Tam düzenleme |
...
2. **Content slug UNIQUE:** Tenant bazlı benzersiz slug indeksi.
...
|------|------|-------------|
| CMS Kategori/Tip | 6 | `tenant/functions/backoffice/content/content_category_*.sql`, `content_type_*.sql` |
| CMS İçerik | 5 | `tenant/functions/backoffice/content/content_create/update/get/list/publish.sql` |
| FAQ | 5 | `tenant/functions/backoffice/content/faq_*.sql` |
| Popup | 8 | `tenant/functions/backoffice/content/popup_*.sql` |
| Promosyon | 8 | `tenant/functions/backoffice/content/promotion_*.sql` |
| Slide | 10 | `tenant/functions/backoffice/content/slide_*.sql` |
| Güven Logoları | 4 | `tenant/functions/backoffice/content/trust_logo_*.sql` |
| Operatör Lisansları | 4 | `tenant/functions/backoffice/content/operator_license_*.sql` |
| SEO Redirect | 5 | `tenant/functions/backoffice/content/seo_redirect_*.sql` |
| İçerik SEO Meta | 3 | `tenant/functions/backoffice/content/content_seo_*.sql` |

### 8.2 Content Fonksiyonları — FE (9)

| Dosya |
|-------|
| `tenant/functions/frontend/content/public_content_get.sql` |
| `tenant/functions/frontend/content/public_content_list.sql` |
| `tenant/functions/frontend/content/public_faq_list.sql` |
| `tenant/functions/frontend/content/public_faq_get.sql` |
| `tenant/functions/frontend/content/public_popup_list.sql` |
| `tenant/functions/frontend/content/public_promotion_list.sql` |
| `tenant/functions/frontend/content/public_promotion_get.sql` |
| `tenant/functions/frontend/content/public_slide_list.sql` |
| `tenant/functions/frontend/content/get_public_trust_elements.sql` |

### 8.3 Presentation Fonksiyonları — BO (26)

| Grup | Adet | Dosya Konumu |
|------|------|-------------|
| Navigasyon | 7 | `tenant/functions/backoffice/presentation/navigation_*.sql` |
| Tema | 4 | `tenant/functions/backoffice/presentation/theme_*.sql` |
| Layout | 4 | `tenant/functions/backoffice/presentation/layout_*.sql` |
| Sosyal Medya | 4 | `tenant/functions/backoffice/presentation/social_link_*.sql` |
| Site Ayarları | 3 | `tenant/functions/backoffice/presentation/site_settings_*.sql` |
| Duyuru Çubukları | 4 | `tenant/functions/backoffice/presentation/announcement_bar_*.sql` |

### 8.4 Presentation Fonksiyonları — FE (4)

| Dosya |
|-------|
| `tenant/functions/frontend/presentation/public_navigation_get.sql` |
| `tenant/functions/frontend/presentation/public_theme_get.sql` |
| `tenant/functions/frontend/presentation/public_layout_get.sql` |
| `tenant/functions/frontend/presentation/get_active_announcement_bars.sql` |

### 8.5 Game (Lobi/Etiket) Fonksiyonları (12)

| Grup | Adet | Dosya Konumu |
|------|------|-------------|
| Lobi BO | 8 | `tenant/functions/backoffice/game/lobby_section_*.sql` |
| Etiket BO | 3 | `tenant/functions/backoffice/game/game_label_*.sql` |
| Lobi FE | 1 | `tenant/functions/frontend/game/public_lobby_get.sql` |

### 8.6 Messaging (Tercih) Fonksiyonları (3)

| Dosya |
|-------|
| `tenant/functions/backoffice/messaging/player_message_preference_bo_get.sql` |
| `tenant/functions/frontend/messaging/player_message_preference_get.sql` |
| `tenant/functions/frontend/messaging/player_message_preference_upsert.sql` |

### 8.7 Tablo Dosyaları (~50)

| Grup | Konum |
|------|-------|
| Content (~35) | `tenant/tables/content/cms/`, `faq/`, `popup/`, `promotion/`, `slide/`, `trust/`, `seo/` |
| Presentation (7) | `tenant/tables/presentation/` |
| Game Lobi (~4) | `tenant/tables/game/` (lobby + label tablolar) |
| Messaging (1) | `tenant/tables/messaging/player_message_preferences.sql` |
