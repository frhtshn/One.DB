...
JOIN (VALUES
    ...
    ('menu.main.live-casino', 'Live Casino'),
    ('menu.main.sports', 'Sports'),
    ('menu.main.promotions', 'Promotions'),
    ('menu.main.tournaments', 'Tournaments'),
    ('menu.main.vip', 'VIP'),
    ('menu.main.login', 'Login'),
    ('menu.main.register', 'Register'),
    ('menu.casino.slots', 'Slots'),
    ('menu.casino.table-games', 'Table Games'),
    ('menu.casino.jackpots', 'Jackpots'),
    ('menu.casino.new-games', 'New Games'),
    ('menu.live-casino.roulette', 'Live Roulette'),
    ('menu.live-casino.blackjack', 'Live Blackjack'),
    ('menu.live-casino.baccarat', 'Live Baccarat'),
    ('menu.live-casino.game-shows', 'Game Shows'),
    ('menu.sports.football', 'Football'),
    ('menu.sports.basketball', 'Basketball'),
    ('menu.sports.tennis', 'Tennis'),
    ('menu.sports.live', 'Live Betting'),
    ('menu.footer.about', 'About Us'),
    ('menu.footer.responsible-gaming', 'Responsible Gaming'),
    ('menu.footer.privacy', 'Privacy Policy'),
    ('menu.footer.terms', 'Terms & Conditions'),
    ('menu.footer.casino', 'Casino'),
    ('menu.footer.live-casino', 'Live Casino'),
    ('menu.footer.sports', 'Sports'),
    ('menu.footer.promotions', 'Promotions'),
    ('menu.footer.help', 'Help Center'),
    ('menu.footer.contact', 'Contact Us'),
    ('menu.footer.affiliates', 'Affiliates'),
    ('menu.footer.account', 'My Account'),
    ('menu.footer.deposit', 'Deposit'),
    ('menu.footer.withdraw', 'Withdraw'),
    ('menu.mobile.home', 'Home'),
    ('menu.mobile.casino', 'Casino'),
    ('menu.mobile.sports', 'Sports'),
    ('menu.mobile.promotions', 'Promotions'),
    ('menu.mobile.account', 'My Account')
