...
FROM presentation.menus m
JOIN (VALUES
    ('companies', 'page-company-list', '/companies', 'ui.page.companies', 'company.list', 1)
...
-- Company List (page perm: company.list)
...
-- ----------------------------------------------------------------
-- 7.5 PROVIDER DETAIL CONTEXTS (2)
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- 7.6 NAV TEMPLATE DETAIL CONTEXTS (1)
-- ----------------------------------------------------------------
...
BEGIN
    ...
    RAISE NOTICE '================================================';
    RAISE NOTICE 'Menu Groups: % (beklenen: 4)', v_menu_groups;
    RAISE NOTICE 'Menus: % (beklenen: 7)', v_menus;
    RAISE NOTICE 'Submenus: % (beklenen: 10)', v_submenus;
    RAISE NOTICE 'Pages: % (beklenen: 34)', v_pages;
    RAISE NOTICE 'Tabs: % (beklenen: 23)', v_tabs;
    RAISE NOTICE 'Contexts: % (beklenen: 37)', v_contexts;
    RAISE NOTICE '================================================';
END $$;
