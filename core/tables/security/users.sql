...
CREATE TABLE security.users (
    ...
    email VARCHAR(255) NOT NULL,                           -- E-posta adresi (giriş için kullanılabilir)
    ...
    is_locked BOOLEAN NOT NULL DEFAULT false,              -- Hesap kilitli mi? (başarısız giriş sonrası)
    ...
    two_factor_secret VARCHAR(255),                        -- 2FA gizli anahtarı (TOTP)

    language CHAR(2),                                      -- Tercih edilen dil (FK: catalog.languages)
