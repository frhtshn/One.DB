...
CREATE INDEX idx_billing_periods_status ON billing.tenant_billing_periods USING btree(status);
CREATE INDEX idx_billing_periods_period ON billing.tenant_billing_periods USING btree(period_start, period_end);

-- tenant_commission_rates
CREATE INDEX idx_tenant_commission_rates_provider ON billing.tenant_commission_rates USING btree(provider_id);
CREATE INDEX idx_tenant_commission_rates_active ON billing.tenant_commission_rates USING btree(provider_id, is_active) WHERE is_active = true;
CREATE INDEX idx_tenant_commission_rates_lookup ON billing.tenant_commission_rates USING btree(provider_id, product_code, commission_type, is_active) WHERE is_active = true;

-- tenant_commission_rate_tiers
CREATE INDEX idx_tenant_commission_rate_tiers_rate ON billing.tenant_commission_rate_tiers USING btree(rate_id);
CREATE INDEX idx_tenant_commission_rate_tiers_order ON billing.tenant_commission_rate_tiers USING btree(rate_id, tier_order);

-- tenant_commission_plans
CREATE INDEX idx_tenant_commission_plans_tenant ON billing.tenant_commission_plans USING btree(tenant_id);
...
CREATE INDEX idx_tenant_commission_plan_tiers_order ON billing.tenant_commission_plan_tiers USING btree(tenant_commission_plan_id, tier_order);

-- tenant_commission_aggregates
CREATE INDEX idx_tenant_commission_aggregates_tenant ON billing.tenant_commission_aggregates USING btree(tenant_id);
...
CREATE INDEX idx_tenant_commissions_provider ON billing.tenant_commissions USING btree(provider_id);
CREATE INDEX idx_tenant_commissions_period ON billing.tenant_commissions USING btree(period_key);
...
CREATE INDEX idx_tenant_invoices_status ON billing.tenant_invoices USING btree(status);
CREATE INDEX idx_tenant_invoices_date ON billing.tenant_invoices USING btree(invoice_date);
CREATE INDEX idx_tenant_invoices_due ON billing.tenant_invoices USING btree(due_date);
CREATE INDEX idx_tenant_invoices_period ON billing.tenant_invoices USING btree(period_start, period_end);

-- tenant_invoice_items
CREATE INDEX idx_tenant_invoice_items_invoice ON billing.tenant_invoice_items USING btree(tenant_invoice_id);
CREATE INDEX idx_tenant_invoice_items_commission ON billing.tenant_invoice_items USING btree(tenant_commission_id) WHERE tenant_commission_id IS NOT NULL;

-- tenant_invoice_payments
CREATE INDEX idx_tenant_invoice_payments_invoice ON billing.tenant_invoice_payments USING btree(tenant_invoice_id);
CREATE INDEX idx_tenant_invoice_payments_date ON billing.tenant_invoice_payments USING btree(payment_date);


-- PROVIDER BILLING INDEXES

-- provider_commission_rates
CREATE INDEX idx_provider_commission_rates_provider ON billing.provider_commission_rates USING btree(provider_id);
CREATE INDEX idx_provider_commission_rates_active ON billing.provider_commission_rates USING btree(provider_id, is_active) WHERE is_active = true;
CREATE INDEX idx_provider_commission_rates_lookup ON billing.provider_commission_rates USING btree(provider_id, product_code, commission_type, is_active) WHERE is_active = true;

-- provider_commission_tiers
CREATE INDEX idx_provider_commission_tiers_rate ON billing.provider_commission_tiers USING btree(provider_commission_rate_id);
CREATE INDEX idx_provider_commission_tiers_order ON billing.provider_commission_tiers USING btree(provider_commission_rate_id, tier_order);
...
CREATE INDEX idx_provider_invoices_status ON billing.provider_invoices USING btree(status);
...
CREATE INDEX idx_provider_invoice_items_tenant ON billing.provider_invoice_items USING btree(tenant_id) WHERE tenant_id IS NOT NULL;

-- provider_payments
CREATE INDEX idx_provider_payments_provider ON billing.provider_payments USING btree(provider_id);
CREATE INDEX idx_provider_payments_invoice ON billing.provider_payments USING btree(provider_invoice_id) WHERE provider_invoice_id IS NOT NULL;
CREATE INDEX idx_provider_payments_date ON billing.provider_payments USING btree(payment_date);
CREATE INDEX idx_provider_payments_status ON billing.provider_payments USING btree(status);
