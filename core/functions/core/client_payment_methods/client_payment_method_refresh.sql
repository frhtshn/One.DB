-- ================================================================
-- CLIENT_PAYMENT_METHOD_REFRESH: Yeni ödeme metotlarını toplu seed et
-- ================================================================
...
DROP FUNCTION IF EXISTS core.client_payment_method_refresh(BIGINT, BIGINT, BIGINT, TEXT);

CREATE OR REPLACE FUNCTION core.client_payment_method_refresh(
    p_caller_id BIGINT,
    p_client_id BIGINT,
...
COMMENT ON FUNCTION core.client_payment_method_refresh IS 'Seeds new payment methods for a client from backend-provided data (cross-DB orchestration). Existing methods untouched (ON CONFLICT DO NOTHING). Returns inserted count. IDOR protected.';
