...
DROP FUNCTION IF EXISTS catalog.kyc_level_requirement_get(INT);
...
COMMENT ON FUNCTION catalog.kyc_level_requirement_get IS 'Gets a single KYC level requirement by ID.';
