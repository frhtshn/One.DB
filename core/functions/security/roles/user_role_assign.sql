-- =============================================
-- 11. USER_ROLE_ASSIGN: Kullaniciya global rol ata
...
BEGIN
    ...
    IF NOT v_already_assigned THEN
        -- Assign
        INSERT INTO security.user_roles (user_id, role_id, assigned_at, assigned_by)
...
COMMENT ON FUNCTION security.user_role_assign IS 'Assigns a global role to a user. Idempotent.';
