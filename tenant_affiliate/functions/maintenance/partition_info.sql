...
-- tenant_affiliate veritabanı için monitoring ve health check
...
COMMENT ON FUNCTION maintenance.partition_info() IS 'Reports partition status for all partitioned tables in tenant_affiliate. Shows count, size, oldest/newest partitions.';
