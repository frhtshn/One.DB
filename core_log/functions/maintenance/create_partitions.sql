...
-- core_log veritabanı için daily partition yönetimi
...
BEGIN
    ...
    FOR v_tbl IN
        SELECT * FROM (VALUES
            ...
            ('backoffice', 'audit_logs',          'created_at')
...
COMMENT ON FUNCTION maintenance.create_partitions(INT) IS 'Creates daily partitions for core_log tables. Look-ahead: today + N days. Idempotent.';
