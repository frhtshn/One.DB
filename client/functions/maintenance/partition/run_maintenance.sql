...
COMMENT ON FUNCTION maintenance.run_maintenance(INT, INT, INT) IS 'Main maintenance function for cron jobs. Creates future partitions (monthly + daily) and drops expired ones across all schemas. Per-table retention defaults or global override.';
