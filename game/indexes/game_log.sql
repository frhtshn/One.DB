...
CREATE INDEX IF NOT EXISTS idx_game_api_req_tenant ON game_log.provider_api_requests USING btree(tenant_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_game_api_cb_tenant ON game_log.provider_api_callbacks USING btree(tenant_id, created_at DESC) WHERE tenant_id IS NOT NULL;
