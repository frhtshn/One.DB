...
CREATE INDEX IF NOT EXISTS idx_fin_api_req_client ON finance_log.provider_api_requests USING btree(client_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_fin_api_cb_client ON finance_log.provider_api_callbacks USING btree(client_id, created_at DESC) WHERE client_id IS NOT NULL;
