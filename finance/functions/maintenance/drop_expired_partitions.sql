...
-- Aktif günün partition'ını ASLA silmez
-- ================================================================
...
CREATE OR REPLACE FUNCTION maintenance.drop_expired_partitions(
    p_retention_days INT DEFAULT 14  -- 14 gün varsayılan retention
)
RETURNS TABLE (
    table_name TEXT,
    partition_name TEXT,
...
COMMENT ON FUNCTION maintenance.drop_expired_partitions(INT) IS 'Drops daily partitions older than retention period (default 14 days) for finance_log tables. Never drops today.';
