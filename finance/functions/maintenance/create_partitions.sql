...
-- Finance veritabanı: finance_log schema'sı için
...
COMMENT ON FUNCTION maintenance.create_partitions(INT) IS 'Creates daily partitions for finance_log tables (provider_api_requests, provider_api_callbacks). Look-ahead: today + N days. Idempotent.';
