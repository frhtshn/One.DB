...
COMMENT ON FUNCTION catalog.payment_method_list(BIGINT, VARCHAR, BOOLEAN) IS 'Lists payment methods from Finance DB catalog with optional provider, type, and status filters. Supports fiat and crypto currencies.';
