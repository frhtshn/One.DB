...
-- ================================================================
-- Tüm detayları içerir (JOIN payment_providers).
...
COMMENT ON FUNCTION catalog.payment_method_get(BIGINT) IS 'Gets a single payment method with all details from Finance DB catalog. Joins payment_providers for provider info. Supports fiat and crypto currencies.';
